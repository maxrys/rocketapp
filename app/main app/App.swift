...
@main struct ThisApp: App {
    ...
    static let NEW_PROFILE_IS_SHOW_TITLE = true
    ...
    static let GRID_COLS: GridCellsByAxisCount = 30
    static let GRID_ROWS: GridCellsByAxisCount = 30
    ...
    public var body: some Scene {
        ...
        .onChange(of: self.profiles.current, { _, _ in
            self.cells.setProfileID(
                self.profiles.current.ID
            )
        })
    }
